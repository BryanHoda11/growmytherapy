...
const About = () => {
    return (
        <>
            <div className="about my-10 w-[85%] mx-auto h-auto flex justify-center gap-5">
                <div className="info w-[60%]">
                    <h3 className="text-2xl pb-5 font-semibold">About Dr. Serena Blake</h3>

                    <div className="paras flex flex-col gap-4">
                        <p>Hello! Welcome to my page, I am Dr. Serena. I treat people with therapy going through hardships like depression, relationship issues & stress. I have 8+ years of experience in this field and have consulted 500+ patients. I have been quiet successful and helped people cure / heal from the problems they go through. In this website you'll know me very well but still if you have queries feel free to contact me!</p>
